...
const CANONICAL_SLOT_MODELS = {
  ...
  'phone-oval': [
    ...
    { slotId: 'lower-left', anchorRole: 'lower-left', anchorZone: 'table-flank', normalized: { x: -1, y: 0.41 } },
    { slotId: 'upper-left', anchorRole: 'upper-left', anchorZone: 'table-flank', normalized: { x: -1, y: -0.48 } },
    { slotId: 'top-left', anchorRole: 'top-left', anchorZone: 'table-flank', normalized: { x: -0.9, y: -0.91 } },
    { slotId: 'top', anchorRole: 'top', anchorZone: 'stage-band-clear', normalized: { x: 0, y: -0.91 } },
    { slotId: 'top-right', anchorRole: 'top-right', anchorZone: 'table-flank', normalized: { x: 0.9, y: -0.91 } },
    { slotId: 'upper-right', anchorRole: 'upper-right', anchorZone: 'table-flank', normalized: { x: 1, y: -0.48 } },
    { slotId: 'lower-right', anchorRole: 'lower-right', anchorZone: 'table-flank', normalized: { x: 1, y: 0.41 } },
    { slotId: 'near-hero-right', anchorRole: 'near-hero-right', anchorZone: 'table-flank', normalized: { x: 0.92, y: 0.98 } },
  ],
};
