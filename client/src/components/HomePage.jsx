    ...
    <div className="min-h-screen bg-gradient-to-br from-poker-dark via-gray-900 to-poker-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <header className="text-center mb-12">
          <div className="mb-6">
            <div className="text-6xl mb-4" role="img" aria-label="扑克牌图标">🃏</div>
        ...
        <main className="space-y-6">
          ...
          {/* 分隔线 */}
          <div className="flex items-center" role="separator" aria-hidden="true">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="room-id-input" className="block text-sm font-medium text-gray-300 mb-2">
                  房间ID
                </label>
                <input
                  id="room-id-input"
                  ...
                  maxLength={6}
                />
                <p id="room-id-help" className="text-xs text-gray-500 mt-1 text-center">
                  按回车键快速加入
                </p>
              </div>
