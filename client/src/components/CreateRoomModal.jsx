  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="create-room-modal__layout">
          ...
          <div className="create-room-modal__main-grid">
            <section className="create-room-modal__section create-room-modal__settings-panel">
              <div className="create-room-modal__section-header">
                <div>
            ...
            <section className="create-room-modal__section create-room-modal__section--advanced create-room-modal__advanced-panel">
              <button
                type="button"
