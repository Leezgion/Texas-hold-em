...
class Validator {
  ...
  static validateRoomSettings(settings) {
    ...
    if (typeof maxPlayers !== 'number' || 
        maxPlayers < GAME_CONFIG.MIN_PLAYERS || 
    ...
    if (typeof initialChips !== 'number' || 
        initialChips < GAME_CONFIG.MIN_CHIPS || 
        initialChips > GAME_CONFIG.MAX_CHIPS) {
      return {
        valid: false,
    ...
    if (typeof timeLimit !== 'number' || 
        timeLimit < GAME_CONFIG.MIN_TIME_LIMIT || 
        timeLimit > GAME_CONFIG.MAX_TIME_LIMIT) {
      return {
        valid: false,
