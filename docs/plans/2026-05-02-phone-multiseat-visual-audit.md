...
- `[todo]` Continue professional-player gameplay validation for side-pot replay drill-down, odd-chip split display, and timeout/disconnect behavior during current-player decision states.
