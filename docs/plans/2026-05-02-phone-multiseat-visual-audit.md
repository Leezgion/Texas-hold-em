...
- `[todo]` Validate post-settlement reveal/history persistence across automatic next-hand transitions and longer reveal sequences after the settlement sheet disappears.
