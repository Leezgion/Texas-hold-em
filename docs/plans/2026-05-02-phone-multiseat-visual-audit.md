...
- `[done]` Continue the deeper edge-case gameplay browser suite; browser audits `mopdq4ur`, `mopdq8by`, `mopdqfle`, `mopdqt0n`, `mopdr59y`, `mopdrf5w`, `moot152q`, `mopdrl6j`, `mopdrxqx`, `mopds3vr`, `mopds7hd`, `mopdsb03`, `mopdsfnj`, `mopdskjt`, and `mopdsotc` passed side pots, non-full all-in, disconnect handoff, invalid actions, duplicate guard, rebuy, stale rooms, post-closed-room continuation, post-settlement history, and multi-hand continuity.
- `[todo]` Start the professional-player cockpit refinement pass: tighten live decision information density, misclick prevention, timer-pressure feedback, and phone interaction smoothness now that the functional edge suite is stable.
