...
- `[todo]` Polish the join-room modal visual density and retry state so failed joins feel like a compact Poker OS terminal flow rather than the legacy gray form.
